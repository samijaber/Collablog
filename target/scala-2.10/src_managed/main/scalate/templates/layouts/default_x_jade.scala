...
object $_scalate_$default_x_jade {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    ;{
      ...
      ;{
        ...
        ;{
          val title: String = $_scalate_$_context.attributeOrElse("title", "DogeBarks")
          ;{
...
class $_scalate_$default_x_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$default_x_jade.$_scalate_$render(context)
}
